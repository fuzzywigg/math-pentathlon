/**
 * Wave 41 — Hex-a-Gone AI selection/placement/execute leftovers. Tests-only. No product inventing.
 */
...
describe('Wave 41 hex-a-gone — AI getAISelection / placement / execute / isAITurn', () => {
