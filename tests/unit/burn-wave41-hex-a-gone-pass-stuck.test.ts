/**
 * Wave 41 — Hex-a-Gone passTurn / canPlayerMove / stuck leftovers. Tests-only. No product inventing.
 */
...
describe('Wave 41 hex-a-gone — passTurn no-op / canPlayerMove / mutual stuck', () => {
