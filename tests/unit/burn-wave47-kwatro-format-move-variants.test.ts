/**
 * Wave 47 leftover after #214/#215 — Kwatro-Sinko formatMove with and without alignment from history. Tests-only.
 */
...
describe('Wave 47 kwatro deepen 19 — kwatro-sinko — format move variants', () => {
