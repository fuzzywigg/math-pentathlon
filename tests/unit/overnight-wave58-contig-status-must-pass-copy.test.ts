/**
 * Wave 58 leftover after #275 — Contig must-pass calculating copy. Tests-only.
 */
...
describe('Wave 58 contig — must-pass copy', () => {
  it('calculating with full board shows must-pass instruction', async () => {
    const actual = await vi.importActual<typeof import('../../src/games/contig-60/types')>(
      '../../src/games/contig-60/types'
    );
