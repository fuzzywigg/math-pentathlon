...
describe('Wave 64 core owl — format tutorial-complete-1', () => {
  ...
  it('selects tutorial-complete-1 and substitutes gameName', () => {
    ...
    expect(msg!.id).toBe('tutorial-complete-1');
    expect(msg!.text).toBe(
      'Tutorial complete! You now know how to play Hex. Time to put it into practice!'
    );
  });
