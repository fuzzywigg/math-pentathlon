/**
 * Wave 47 leftover after #214/#215 leftovers D — Hex-a-Gone deselect clears preview. Tests-only. No product inventing.
 */
import { describe, it, expect } from 'vitest';
import { createInitialState } from '../../src/games/hex-a-gone/types';
import { selectBlock, deselectBlock } from '../../src/games/hex-a-gone/rules';

describe('Wave 47 hex-a-gone deepen 12 — hexagone — deselect clears selectedBlockForPlacement', () => {
