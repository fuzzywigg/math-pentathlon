/**
 * Wave 24 — multi-step bank/cubes/chips/deck/bars/progress conservation.
 * Revives closed #129 ledger slice after #127. Distinct from wave 19 opening
 * inventory invariants and wave 16 place→score MatchDetails.
