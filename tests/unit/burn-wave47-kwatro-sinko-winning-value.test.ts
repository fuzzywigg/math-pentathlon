/**
 * Wave 47 leftover after #214/#215 — Kwatro-Sinko isWinningValue leftovers. Tests-only. No product inventing.
 */
import { describe, it, expect } from 'vitest';
import { isWinningValue, CONFIG } from '../../src/games/kwatro-sinko/types';

describe('Wave 47 kwatro deepen 10 — kwatro — isWinningValue from types', () => {
