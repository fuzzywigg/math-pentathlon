/**
 * Wave 47 leftover after #214/#215 — Kwatro-Sinko hasValidMoves / zero-move select matrix. Tests-only.
 */
...
describe('Wave 47 kwatro deepen 1 — kwatro-sinko — hasValidMoves matrix', () => {
