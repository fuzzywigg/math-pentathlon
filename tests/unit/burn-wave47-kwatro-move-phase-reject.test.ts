/**
 * Wave 47 leftover after #214/#215 — Kwatro-Sinko isValidMove / moveChip phase rejects. Tests-only.
 */
...
describe('Wave 47 kwatro deepen 2 — kwatro-sinko — move phase reject', () => {
