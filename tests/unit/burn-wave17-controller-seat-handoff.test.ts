/**
 * Wave 17 — legal controller seat-handoffs (DOM click → phase/seat/status).
 * Distinct from wave 15 (rules illegal / getValid* / clock), wave 16 (AI pipelines),
 * and closed #116 (rules-only multi-ply SUCCESS playthroughs).
...
describe('Wave 17 seat-handoff — Hex legal click flips seat + status', () => {
...
describe('Wave 17 seat-handoff — Calla valid pit advances history/status', () => {
...
describe('Wave 17 seat-handoff — FIAR place flips seat; re-click no-op', () => {
...
describe('Wave 17 seat-handoff — Kings full turn flips seat', () => {
...
describe('Wave 17 seat-handoff — Star Track draw→chain flips seat', () => {
...
describe('Wave 17 seat-handoff — Hex-a-Gone select→confirm enters place', () => {
...
describe('Wave 17 seat-handoff — Queens select→legal move updates status', () => {
...
describe('Wave 17 seat-handoff — Contig roll advances chrome', () => {
...
describe('Wave 17 seat-handoff — Juggle roll advances status instruction', () => {
...
describe('Wave 17 seat-handoff — Sum Dominoes roll→place when playable', () => {
...
describe('Wave 17 seat-handoff — Prime Gold roll→place when valid', () => {
...
describe('Wave 17 seat-handoff — Par 55 select→place flips seat', () => {
...
describe('Wave 17 seat-handoff — Stars & Bars select→place flips seat', () => {
...
describe('Wave 17 seat-handoff — Ramrod / Kwatro select advances phase chrome', () => {
...
describe('Wave 17 seat-handoff — owl start/end gates on legal openers', () => {
