/**
 * Wave 25 — timer format/parse options + scoring multiplier/result edges.
 * Distinct from wave 15 clock-edges game turns and timer-scoring.test smoke.
...
describe('Wave 25 timer — format/parse option matrix', () => {
...
describe('Wave 25 scoring — multipliers / win / results', () => {
