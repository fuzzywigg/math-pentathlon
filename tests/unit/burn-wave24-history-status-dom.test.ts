/**
 * Wave 24 — formatMove ↔ history DOM + status chrome after legal moves.
 * Revives closed #119/#121 after #127. Distinct from wave 19 status-ui-edges
 * remount smoke and wave 20 controller mode matrix.
...
describe('Wave 24 history-DOM — Fab formatMove equation appears in render', () => {
...
describe('Wave 24 history-DOM — Par place → formatMove + history row', () => {
...
describe('Wave 24 history-DOM — Ramrod place → formatMove + history chrome', () => {
...
describe('Wave 24 history-DOM — Kwatro move → formatMove + history chip text', () => {
...
describe('Wave 24 history-DOM — Sum Dominoes formatMove after place', () => {
...
describe('Wave 24 history-DOM — Stars / Prime render after rules place', () => {
...
describe('Wave 24 history-DOM — Kings history mounts after controller turn', () => {
...
describe('Wave 24 status-DOM — Hex/Calla/Star/FIAR after legal move', () => {
...
describe('Wave 24 history-DOM — controller Par/Stars/Prime after legal place', () => {
