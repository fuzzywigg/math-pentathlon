/**
 * Wave 65 leftover after tip/#315 — Kwatro winning alignment-must-satisfy exact.
 * Wave55 soft a+b-c=4; deepen OR strong pair leftover. Tests-only.
 */
import { describe, it, expect } from 'vitest';
import { kwatroSinkoTutorial } from '../../src/games/kwatro-sinko/tutorial';

describe('Wave 65 kwatro — tutorial winning alignment satisfy exact', () => {
