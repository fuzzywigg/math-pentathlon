/**
 * Wave 25 — fractions performOperation / parseFraction / formatMixedNumber.
...
describe('Wave 25 fractions — performOperation steps', () => {
  ...
  it('add same denominator skips LCD step; add() already simplifies', () => {
    ...
    // arithmetic.add returns simplified, so result === simplified (no extra step)
  ...
  it('result vs simplified diverge when unsimplified form is returned', () => {
    const out = performOperation(
      createFraction(1, 6),
      createFraction(1, 3),
      'add'
...
describe('Wave 25 fractions — parseFraction + formatMixedNumber', () => {
