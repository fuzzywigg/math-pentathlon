/**
 * Wave 67 leftover after tip/#324 — Kwatro empty node stroke-width 1 / #ccc.
 * Soft #f5f5f5 fill; deepen stroke leftover. Tests-only.
 */
import { describe, it, expect } from 'vitest';
import { createInitialState } from '../../src/games/kwatro-sinko/rules';
import { renderBoard } from '../../src/games/kwatro-sinko/board-ui';

describe('Wave 67 kwatro — render empty node stroke-width 1', () => {
  it('empty mid node uses #f5f5f5 / #ccc / stroke-width 1', () => {
