/**
 * Wave 41 — Kwatro-Sinko alignment-approach move sequences leftovers. Tests-only. No product inventing.
 */
...
describe('Wave 41 kwatro — deep alignment approach + illegal reject', () => {
