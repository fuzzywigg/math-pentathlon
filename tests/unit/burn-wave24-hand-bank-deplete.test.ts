 ...
 * Second lane after #127 (tutorial/reject/dice-expr). Distinct from open #130
 * hex-ui/polyomino-ui/storage/owl and from wave 19–22 burns. Revives closed
 * #129 inventory vertical as Vitest-only (no e2e). Tests-only. No product inventing.
 */
