/**
 * Wave 67 leftover after tip/#324 — Kwatro residual handshake (unit-only).
 * Distinct from wave63/wave60 game-area/Red/Objective; deepen flex/border/strategy. Tests-only.
 */
