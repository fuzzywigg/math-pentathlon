/**
 * Wave 47 leftover after #214/#215 — Par 55 executeAITurn pass / empty hand leftovers after #186. Tests-only.
 */
...
describe('Wave 47 par deepen 4 — Wave 47 par55 — executeAITurn pass paths', () => {
  afterEach(() => {
    vi.restoreAllMocks();
  });
