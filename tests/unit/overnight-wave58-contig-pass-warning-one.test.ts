/**
 * Wave 58 leftover after #275 — Contig pass warning (1/3 passes). Tests-only.
 */
...
describe('Wave 58 contig — pass warning one', () => {
  it('appends (1/3 passes) on rolling status', async () => {
