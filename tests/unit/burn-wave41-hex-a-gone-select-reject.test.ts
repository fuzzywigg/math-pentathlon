/**
 * Wave 41 — Hex-a-Gone selectBlock / deselectBlock leftovers. Tests-only. No product inventing.
 */
...
describe('Wave 41 hex-a-gone — select max-3 / duplicate / empty bank / deselect', () => {
