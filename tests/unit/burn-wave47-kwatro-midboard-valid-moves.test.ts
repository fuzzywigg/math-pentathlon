/**
 * Wave 47 leftover after #214/#215 — Kwatro-Sinko getValidMoves after forged mid-board positions. Tests-only.
 */
...
describe('Wave 47 kwatro deepen 20 — kwatro-sinko — mid-board valid moves', () => {
