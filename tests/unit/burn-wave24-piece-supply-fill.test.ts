/**
 * Wave 24 — piece/supply/fill ledgers after legal place (Pent/Kings/Juggle/…).
 * Revives closed #122/#129 after #127. Distinct from wave 20 board-bounds
 * Hex-a-Gone radius inventory and wave 21 polyomino empty-inventory edges.
