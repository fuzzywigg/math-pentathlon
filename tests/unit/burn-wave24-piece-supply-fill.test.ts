/**
 * Wave 24 — piece supply / board-fill resource accounting after legal play.
 * Second lane after #127. Distinct from #130 polyomino-ui and wave 21
 * polyomino-solve. Vitest-only. No product inventing.
 */
...
describe('Wave 24 piece-supply — Pent-em-In available→placed', () => {
...
describe('Wave 24 piece-supply — Kings Quadraphages supply ledger', () => {
...
describe('Wave 24 piece-supply — Juggle board fill rises after monomino', () => {
...
describe('Wave 24 piece-supply — Prime chip inventory + cell claim', () => {
...
describe('Wave 24 piece-supply — Contig claims empty cell inventory', () => {
...
describe('Wave 24 piece-supply — Kwatro chip position inventory', () => {
...
describe('Wave 24 piece-supply — Calla cube totals redistribute', () => {
...
describe('Wave 24 piece-supply — Hex cell occupancy inventory', () => {
...
describe('Wave 24 piece-supply — Queens piece relocation inventory', () => {
  it('makeMove relocates piece without inventing new piece ids', () => {
    let state = createQueens();
    const piecesBefore = [...state.cells.values()].filter(
      (c) => c.piece
    ).length;
