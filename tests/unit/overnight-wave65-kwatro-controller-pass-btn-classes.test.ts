/**
 * Wave 65 leftover after tip/#315 — Kwatro Pass Turn btn classes.
...
describe('Wave 65 kwatro — controller pass btn classes', () => {
  beforeEach(() => {
  ...
  it('Pass Turn uses kwa-btn kwa-btn-secondary when no valids', () => {
    ...
    // Block all Blue chips from moving by filling neighbors — simpler: stub hasValidMoves via empty connections
