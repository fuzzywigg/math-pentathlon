/**
 * Wave 27 — graph algorithms path/component/region edges.
 * Deepens beyond graph.test.ts. Distinct from wave 22 graph-ui and wave 25 contiguous.
...
describe('Wave 27 graph — paths + distance deepen', () => {
...
describe('Wave 27 graph — components + directed reachability', () => {
...
describe('Wave 27 graph — player regions', () => {
