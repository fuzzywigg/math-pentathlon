/**
 * Wave 20 — getOpponent seat-flip identity across existing games.
 * Still thin after waves 14–19 (rules-phase, AI, midphase, lookup/persist).
...
describe('Wave 20 opponent-identity — player1↔player2 flip', () => {
...
describe('Wave 20 opponent-identity — cross-game agreement', () => {
  ...
  it('covers 18 existing games with getOpponent exports', () => {
    ...
    expect(new Set(OPPONENTS.map((o) => o.name)).size).toBe(18);
  });
});
