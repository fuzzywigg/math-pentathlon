/**
 * Wave 54 leftover after #240 — Fab matchable answer Enter/Space (wave53 click). Tests-only.
 */
...
describe('Wave 54 fab — answer keyboard', () => {
  it('Enter/Space activate unclaimed matchable', () => {
    ...
    const wrap = el.querySelector(`[data-answer-id="${found!.ans}"]`) as HTMLElement;
