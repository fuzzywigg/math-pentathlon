/**
 * Wave 47 leftover after #214/#215 — Sum Dominoes getValidPlacements / canPlay dense matrix. Tests-only.
 */
...
describe('Wave 47 sum deepen 9 — sum-dominoes — valid placements matrix', () => {
