/**
 * Overnight TOKENMAXX HEAVY leftovers after #271 — CI keeps unit + chromium e2e.
 * Wave57 asserted chromium leftover; deepen jobs + alpha branch gate. Tests-only.
 */
import { describe, it, expect } from 'vitest';
import { readFileSync } from 'node:fs';
import { resolve } from 'node:path';

describe('Wave 58 CI — unit/e2e gates', () => {
