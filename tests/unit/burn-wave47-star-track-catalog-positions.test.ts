/**
 * Wave 47 leftover after #214/#215 leftovers D — star-track catalog / position helpers. Tests-only. No product inventing.
 */
...
describe('Wave 47 star-track deepen 12 — D star-track — catalog + position helpers', () => {
