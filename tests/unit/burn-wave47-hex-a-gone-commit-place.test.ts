/**
 * Wave 47 leftover after #214/#215 — Hex-a-Gone commit / place / canPlaceAt leftovers. Tests-only. No product inventing.
 */
...
describe('Wave 47 hex-a-gone deepen 1 — hex-a-gone — commit / placement rejects / multi-block turn', () => {
