/**
 * Wave 47 leftover after #214/#215 — Kwatro-Sinko isAITurn matrix including selectingDest phase. Tests-only.
 */
...
describe('Wave 47 kwatro deepen 12 — kwatro-sinko — AI is turn matrix', () => {
