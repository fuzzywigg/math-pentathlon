/**
 * Wave 45 — Sum AI place resets passCount after prior pass
...
describe('Wave 45 Sum AI — place resets passCount', () => {
  it('AI place from placing with passCount 1 clears it', () => {
