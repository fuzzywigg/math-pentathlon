/**
 * Wave 45 — Sum getAIMove does not gate on placing phase
...
describe('Wave 45 Sum AI — passing phase still evals', () => {
  it('returns a move even if phase is passing when dice+hand playable', () => {
