/**
 * Wave 47 leftover after #214/#215 — Kwatro-Sinko getAIMove hard and executeAITurn pass path. Tests-only.
 */
...
describe('Wave 47 kwatro deepen 11 — kwatro-sinko — AI hard execute', () => {
  afterEach(() => {
    vi.restoreAllMocks();
  });
