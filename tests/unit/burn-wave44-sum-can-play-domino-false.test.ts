/**
 * Wave 44 — Sum Dominoes canPlayDomino false leftovers.
 * Tests-only.
 */
...
describe('Wave 44 Sum Dominoes — canPlayDomino false', () => {
  it('zero faces cannot match double-six under sum 12', () => {
    ...
    board[5][5] = placed;
    board[5][6] = placed;
    const d: Domino = { id: 'z', face1: 0, face2: 0, owner: 'player1', orientation: 'horizontal' };
    const state = {
      board,
