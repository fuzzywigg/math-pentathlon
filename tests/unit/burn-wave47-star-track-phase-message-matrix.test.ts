/**
 * Wave 47 leftover after #214/#215 — Star Track phase message + select identity + opponent.
 * Tests-only.
 */
...
describe('Wave 47 star-track deepen 2 — star-track — phase matrix leftovers', () => {
