/**
 * Wave 27 — legal controller seat-handoffs (DOM click → phase/seat/status).
 * Revives never-merged #119/#121/#132 after #138 success-playthroughs + #139 contig + #140 a11y.
 * Distinct from persist/serialize (#120), inventory (#131), success (#138), contiguous (#139).
...
describe('Wave 27 seat-handoff — Calla valid pit advances history/status', () => {
...
describe('Wave 27 seat-handoff — FIAR place flips seat; re-click no-op', () => {
...
describe('Wave 27 seat-handoff — Kings full turn flips seat', () => {
...
describe('Wave 27 seat-handoff — Star Track draw→chain flips seat', () => {
...
describe('Wave 27 seat-handoff — Hex-a-Gone select→confirm enters place', () => {
...
describe('Wave 27 seat-handoff — Queens select→legal move updates status', () => {
...
describe('Wave 27 seat-handoff — Contig roll advances chrome', () => {
...
describe('Wave 27 seat-handoff — Juggle roll advances status instruction', () => {
...
describe('Wave 27 seat-handoff — owl start/end gates on legal openers', () => {
