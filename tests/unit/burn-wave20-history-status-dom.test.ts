/**
 * Wave 20 companion — history/status DOM after legal moves (formatMove ↔ rendered chrome).
 * Distinct from secondary-ui empty mounts, rules-only formatMove checks,
 * and sibling #120 status-ui-edges / serialization.
...
describe('Wave 20 history-DOM — Fab formatMove equation appears in render', () => {
...
describe('Wave 20 history-DOM — Par place → formatMove + history row', () => {
...
describe('Wave 20 history-DOM — Ramrod place → formatMove + history chrome', () => {
...
describe('Wave 20 history-DOM — Kwatro move → formatMove + history chip text', () => {
...
describe('Wave 20 history-DOM — Sum Dominoes formatMove after place', () => {
...
describe('Wave 20 history-DOM — Stars / Prime render after rules place', () => {
...
describe('Wave 20 history-DOM — Kings history mounts after controller turn', () => {
...
describe('Wave 20 status-DOM — Hex/Calla/Star/FIAR after legal move', () => {
...
describe('Wave 20 history-DOM — controller Par/Stars/Prime after legal place', () => {
