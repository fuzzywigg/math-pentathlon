/**
 * Wave 24 — legal controller seat-handoffs (DOM click → phase/seat/status).
 * Revives closed #119/#121 after #127. Distinct from wave 19 persist/serialize,
 * wave 20 opponent/bounds/controllers, wave 22 tutorial/reject/registry.
...
describe('Wave 24 seat-handoff — Hex legal click flips seat + status', () => {
...
describe('Wave 24 seat-handoff — Calla valid pit advances history/status', () => {
...
describe('Wave 24 seat-handoff — FIAR place flips seat; re-click no-op', () => {
...
describe('Wave 24 seat-handoff — Kings full turn flips seat', () => {
...
describe('Wave 24 seat-handoff — Star Track draw→chain flips seat', () => {
...
describe('Wave 24 seat-handoff — Hex-a-Gone select→confirm enters place', () => {
...
describe('Wave 24 seat-handoff — Queens select→legal move updates status', () => {
...
describe('Wave 24 seat-handoff — Contig roll advances chrome', () => {
...
describe('Wave 24 seat-handoff — Juggle roll advances status instruction', () => {
...
describe('Wave 24 seat-handoff — Sum Dominoes roll→place when playable', () => {
...
describe('Wave 24 seat-handoff — Prime Gold roll→place when valid', () => {
...
describe('Wave 24 seat-handoff — Par 55 select→place flips seat', () => {
...
describe('Wave 24 seat-handoff — Stars & Bars select→place flips seat', () => {
...
describe('Wave 24 seat-handoff — Ramrod / Kwatro select advances phase chrome', () => {
...
describe('Wave 24 seat-handoff — owl start/end gates on legal openers', () => {
