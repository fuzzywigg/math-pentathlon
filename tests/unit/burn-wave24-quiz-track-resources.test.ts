/**
 * Wave 24 — quiz/track/island resource drains (Frac/Pinball/Star/Remainder).
 * Revives closed #122/#129 after #127. Distinct from wave 18 math-preview and
 * wave 22 apply-reject mid-state illegal applies.
...
describe('Wave 24 quiz-track — Frac Fact streak/score/wrong ledgers', () => {
...
describe('Wave 24 quiz-track — Pinball ballsRemaining ledger', () => {
...
describe('Wave 24 quiz-track — Star Track bucket + progress', () => {
...
describe('Wave 24 quiz-track — Remainder island ownership + chip spend', () => {
