/**
 * Wave 47 leftover after #214/#215 — Kwatro-Sinko selectChip wrong-owner / missing identity. Tests-only.
 */
...
describe('Wave 47 kwatro deepen 4 — kwatro-sinko — select wrong owner', () => {
