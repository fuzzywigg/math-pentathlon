/**
 * Wave 47 leftover after #214/#215 — Hex-a-Gone getPhaseMessage / getBlockColor / isGameOver leftovers. Tests-only. No product inventing.
 */
...
describe('Wave 47 hex-a-gone deepen 4 — hex-a-gone — phase messages / colors / gameOver', () => {
