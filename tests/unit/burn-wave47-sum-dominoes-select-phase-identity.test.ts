/**
 * Wave 47 leftover after #214/#215 — Sum Dominoes selectDomino phase / missing identity. Tests-only.
 */
...
describe('Wave 47 sum deepen 8 — sum-dominoes — selectDomino identity', () => {
