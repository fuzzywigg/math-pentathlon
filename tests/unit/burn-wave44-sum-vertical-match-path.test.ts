/**
 * Wave 44 — Sum Dominoes vertical match leftovers.
 * Tests-only.
 */
...
describe('Wave 44 Sum Dominoes — vertical match path', () => {
  it('vertical abut left of seed face is valid for sum 7', () => {
    ...
    expect(isValidPlacement(state, d, { row: 5, col: 4 }, 'vertical', 7)).toBe(true);
  });
});
