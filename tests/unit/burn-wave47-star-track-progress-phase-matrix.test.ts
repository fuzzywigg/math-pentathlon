/**
 * Wave 47 leftover after #214/#215 — Star Track progress / phase / bucket catalog leftovers.
 * Tests-only.
 */
...
describe('Wave 47 star-track deepen 3 — Star Track — progress phase matrix', () => {
