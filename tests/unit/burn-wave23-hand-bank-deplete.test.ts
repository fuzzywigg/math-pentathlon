/**
 * Wave 23 — hand / bank / deck depletion after legal success.
 * Revives closed #122 inventory vertical (never merged; wave20 name taken by
 * opponent/bounds). Distinct from wave 19 opening-invariants, wave 16
 * place→score MatchDetails, wave 18 pass/geometry, wave 21 attribute/polyomino,
 * and open wave 22 toolkit UI. Tests-only. No product inventing.
 */
...
describe('Wave 23 hand-bank — Par 55 place depletes selected block', () => {
...
describe('Wave 23 hand-bank — Ramrod place removes rod from seat inventory', () => {
...
describe('Wave 23 hand-bank — Stars placeCard deck/hand ledger', () => {
...
describe('Wave 23 hand-bank — Sum Dominoes depletes without redraw', () => {
...
describe('Wave 23 hand-bank — Hex-a-Gone bank shape count drops', () => {
...
describe('Wave 23 hand-bank — Fab bars marked used + answer claimed', () => {
...
describe('Wave 23 hand-bank — FIAR chipsPlaced ledger', () => {
