/**
 * Wave 41 — Hex-a-Gone full select→commit→place flow leftovers. Tests-only. No product inventing.
 */
...
describe('Wave 41 hex-a-gone — full select→commit→place + mutual pass stuck', () => {
