/**
 * Wave 15b — getPhaseMessage / formatMove / clearSelection edges.
 * Complements burn-wave15-rules-phase (illegal/getValid*). Still rules-only.
 */
...
describe('Wave 15b — Hex-a-Gone / Calla / Star phase messages', () => {
...
describe('Wave 15b — Fab / Par / Ramrod / Kwatro / Stars clearSelection matrix', () => {
...
describe('Wave 15b — Prime / Remainder / Sum / FIAR phase helpers', () => {
