/**
 * Wave 67 leftover after tip/#324 — Sum roll pad + min-width chrome.
...
describe('Wave 67 sum — style roll pad minwidth', () => {
  it('pins sd-roll-btn padding 10px 20px + min-width 120 leftover', () => {
