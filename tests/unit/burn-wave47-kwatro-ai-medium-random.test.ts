/**
 * Wave 47 leftover after #214/#215 — Kwatro-Sinko getAIMove medium difficulty with mocked randomness. Tests-only.
 */
...
describe('Wave 47 kwatro deepen 13 — kwatro-sinko — AI medium random', () => {
  afterEach(() => {
    vi.restoreAllMocks();
  });
