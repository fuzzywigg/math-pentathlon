/**
 * Wave 47 leftover after #214/#215 — Sum Dominoes placeDomino phase / invalid identity. Tests-only.
 */
...
function seededBase(): SumDominoesState {
...
describe('Wave 47 sum deepen 6 — sum-dominoes — placeDomino identity', () => {
